...
if __name__ == "__main__":
    if EVENT_HUB_CONNECTION_STR == "Endpoint=sb://<tu-namespace>.servicebus.windows.net/;SharedAccessKeyName=<tu-key-name>;SharedAccessKey=<tu-key>;EntityPath=<tu-event-hub>" :
